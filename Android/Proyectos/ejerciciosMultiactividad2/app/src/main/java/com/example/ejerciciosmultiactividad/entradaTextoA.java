...
public class entradaTextoA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            podiumPalabrasTv.setText(data.getStringExtra(entradaTextoB.TEXTO_PODIUM));
        ...
        analizarBt.setOnClickListener(view -> {
            Intent i = new Intent(this, entradaTextoB.class);
