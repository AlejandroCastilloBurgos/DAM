...
public class entradaTextoB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entrada_texto_b);
        finAnalisisBt = findViewById(R.id.u3a6idBtFinAnalisis);
        outputTv = findViewById(R.id.u3a6idTvOutput);
        Bundle info = getIntent().getExtras();
        String textoEntrada = info.getString(entradaTextoA.TEXTO_CONTADOR);
