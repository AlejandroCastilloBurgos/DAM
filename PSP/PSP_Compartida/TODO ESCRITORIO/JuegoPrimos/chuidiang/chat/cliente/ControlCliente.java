 ...
 * escribe el usuario en el panel lo enva por el socket.
 * 
 * @author Chuidiang
 *
 */
public class ControlCliente implements ActionListener, Runnable {
     ...
     * pulse el botn de "enviar" o pulse "enter" sobre el textfield.
     */
    ...
    /**
     * Modo run para antender al socket. Todo lo que llega por el socket se
     * escribe en el panel.
     */
    public void run() {
        try {
